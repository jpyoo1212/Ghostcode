...
function RoomLandingInner() {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      sessionStorage.setItem(
        sessionKey(data.roomCode),
        JSON.stringify({ token: data.token, role: data.role, secretKey: data.secretKey })
      );
  ...
  async function handleJoin() {
    ...
    try {
      ...
      sessionStorage.setItem(
        sessionKey(code),
        JSON.stringify({ token: data.token, role: data.role, secretKey: key })
      );
